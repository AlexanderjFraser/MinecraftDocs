...
status** are `docs/pass7-brief.md`; **sessions A–E are done** (2026-09-15) — the
...
session reads first is `entities/entity-lifecycle`, and Parts I–V are clean:
...
gate failures, five parts of five, one on nearly every page,

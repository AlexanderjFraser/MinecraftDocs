...
| `Entity` | 193 | 18 | class | `net/minecraft/world/entity` |
| `Model` | 169 | 13 | class | `net/minecraft/client/model` |
| `AbstractContainerEventHandler` | 158 | 1 | class | `net/minecraft/client/gui/components/events` |
| `Screen` | 157 | 72 | class | `net/minecraft/client/gui/screens` |
...
| `AbstractWidget` | 96 | 12 | class | `net/minecraft/client/gui/components` |
...
| `StructurePiece` | 60 | 8 | class | `net/minecraft/world/level/levelgen/structure` |
| `Behavior` | 56 | 51 | class | `net/minecraft/world/entity/ai/behavior` |
...
| `AgeableMobRenderer` | 45 | 26 | class | `net/minecraft/client/renderer/entity` |
